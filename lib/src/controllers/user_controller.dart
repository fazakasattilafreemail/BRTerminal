...
import 'package:Leuke/src/views/password_login_view.dart';
import 'package:Leuke/src/views/reset_forgot_password_view.dart';
          ...
          userRepo
            ...
            if (value != null) {
              if (value) {
                ...
                print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos1');
        ...
        userRepo
          ...
          if (value != null) {
            if (value) {
              ...
              videoRepo.homeCon.value.showFollowingPage.notifyListeners();
              Navigator.of(userScaffoldKey?.currentContext).pushReplacementNamed('/redirect-page', arguments: 0);
              print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos2');
              videoRepo.homeCon.value.getVideos();
            } else {
              // userRepo.errorString.addListener(() {
              if (userRepo.errorString.value == "") {
          ...
          userRepo.socialLogin(profile, timezone, 'FB').then((value) async {
            if (value != null) {
              if (value) {
                ...
                videoRepo.homeCon.value.showFollowingPage.notifyListeners();
                Navigator.of(userScaffoldKey?.currentContext).pushReplacementNamed('/redirect-page', arguments: 0);
                print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos3');
                videoRepo.homeCon.value.getVideos();
              } else {
                // userRepo.errorString.addListener(() {
                if (userRepo.errorString.value == "") {
        ...
        userRepo.socialLogin(profile, timezone, 'G').then((value) {
          if (value != null) {
            if (value) {
              ...
              videoRepo.homeCon.value.showFollowingPage.notifyListeners();
              Navigator.of(userScaffoldKey?.currentContext).pushReplacementNamed('/redirect-page', arguments: 0);
              print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos4');
              videoRepo.homeCon.value.getVideos();
            } else {
              Helper.hideLoader(loader);
              print("Entered else");
...
//              });
  ...
  Future<void> refreshUserProfile() {
    if (userIdValue.value > 0) {
      ...
      getUsersProfile(userIdValue.value, 1);
    }
  }

  Future<void> refreshMyProfile() {
    getMyProfile(1);
  }
  ...
  blockUser(userId) async {
    ...
    userRepo.blockUser(userId).then((value) async {
      ...
      if (response['status'] == 'success') {
        ...
        // ));
        print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos5');
      ...
      userRepo.register(userProfile).then((value) async {
        ...
        if (value != null) {
          ...
          if (response['status'] != 'success') {
            ...
            print("msg");
            print(msg);
            showAlertDialog("Error Registering User", msg, userScaffoldKey.currentContext);
      ...
      userRepo.socialRegister(userProfile).then((value) async {
        ...
        if (value != null) {
          ...
          if (response['status'] != 'success') {
            ...
            print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos6');
            videoRepo.homeCon.value.getVideos();
          }
        }
      });
      ...
      userRepo.login(userProfile).then((value) async {
        ...
        if (value != null) {
          ...
          if (response['status'] != 'success') {
            ...
            videoRepo.homeCon.value.showFollowingPage.notifyListeners();
            Navigator.of(userScaffoldKey?.currentContext).pushReplacementNamed('/redirect-page', arguments: 0);
            print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos7');
            videoRepo.homeCon.value.getVideos();
          }
        }
      });
    ...
    if (otpFormKey.currentState.validate()) {
      ...
      userRepo.verifyOtp(data).then((value) async {
        ...
        if (response['status'] != 'success') {
          ...
          print('HHHHHHHHHHHHHHHHHHHHHHooolgetvideos8');
          videoRepo.homeCon.value.getVideos();
