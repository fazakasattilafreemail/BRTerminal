...
class FollowingsView extends StatefulWidget {
  ...
  final int type;
  FollowingsView({Key key, this.type, this.parentScaffoldKey})
      : super(key: key);
...
//                              _con.followUnfollowUser(obj.users[i].id, i);
                            ...
                            child: Container(
                              width: 85,
                              height: 26,
                              decoration: (obj.users[i].followText ==
                                      'Following')
                                  ? BoxDecoration(
                      ...
                      child: TextField(
                        ...
                        decoration: new InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            icon: Icon(
                              Icons.clear,
                              color: (_con.searchKeyword.length > 0)
                                  ? Colors.white54
                                  : Colors.black,
                              size: 16,
                            ),
