                ...
                child: AppBar(
                  ...
                  actions: <Widget>[
                    ElevatedButton(
                      ...
                      child: Text(
                        "Done",
                        style: TextStyle(color: Color(0xff4BB543), fontWeight: FontWeight.bold, fontSize: 15),
                      ),
                       ),
                  ],
                ),
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: () {
                                                          showCupertinoDatePicker(context,
                                                            ...
                                                            DateTime result;
                                                            if (date.year > 0) {
                                                              result = DateTime(date.year, date.month, date.day, usersProfileData.value.dob.hour,
                                                                  usersProfileData.value.dob.minute);
                                                        ...
                                                        child: (usersProfileData.value.dob != null)
                                                            ? Text(formatterDate.format(usersProfileData.value.dob),
                                                                textAlign: TextAlign.right, style: TextStyle(fontSize: 15, color: Colors.black))
                                                            : Container(),
                                                      )),
                                                ),
                                              ),
