                              ...
                              child: Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: new InputDecoration(
                                    ...
                                    hintStyle: TextStyle(fontSize: 16.0, color: Colors.white.withOpacity(0.5)),
                                    ...
                                    suffixIcon: IconButton(
                                      ...
                                      icon: Icon(
                                        Icons.clear,
                                        color: _con.searchKeyword != "" ? Colors.white54 : Colors.transparent,
                                        size: 16,
                                      ),
                                    ),
                                  ),
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: new InputDecoration(
                                      ...
                                      suffixIcon: IconButton(
                                        ...
                                        icon: Icon(
                                          Icons.clear,
                                          color: _con.searchKeyword2 != "" ? Colors.white : Colors.transparent,
                                          size: 16,
                                        ),
                                      ),
                                    ),
...
class _SoundCatListState extends StateMVC<SoundCatList> {
  ...
  // final AssetsAudioPlayer _assetsAudioPlayer = null;
                    ...
                    child: TextField(
                      ...
                      decoration: new InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          ...
                          icon: Icon(
                            Icons.clear,
                            color: searchKeyword != "" ? Colors.white54 : Colors.transparent,
                            size: 16,
                          ),
                        ),
                      ),
