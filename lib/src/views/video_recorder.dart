...
class _VideoRecorderState extends StateMVC<VideoRecorder> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _con.sizeAnimation = Tween<double>(begin: 60.0, end: 70.0).animate(_con.animationController);
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: _con.thumbPath != '' ? AssetImage(_con.thumbPath) : AssetImage("assets/images/camera.png"),
                                          fit: BoxFit.none,
                                        ),
                                      ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: MarqueeWidget(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          soundRepo.currentSound.value.title == null || soundRepo.currentSound.value.title == ""
                                              ? "Select Sound "
