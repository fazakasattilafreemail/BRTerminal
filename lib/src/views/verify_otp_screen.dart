                      ...
                      children: <Widget>[
                        (_con.bHideTimer)
                            ? Text(
                                ...
                                style: TextStyle(color: Colors.pinkAccent, fontSize: 20, fontFamily: 'RockWellStd', fontWeight: FontWeight.w400),
                              )
                            : Column(
                                children: <Widget>[
                                  Text("Did not get OTP?",
                                      style: TextStyle(color: Colors.white, fontSize: 17, fontFamily: 'RockWellStd', fontWeight: FontWeight.w100)),
                                  InkWell(
                                    onTap: () {
                                      _con.resendOtp(verifyPage: true);
                                    },
                                    child: Text("Click here to resend OTP",
                                        style: TextStyle(
                                            color: Color(0xfff5ae78), fontSize: 17, fontFamily: 'RockWellStd', fontWeight: FontWeight.w400)),
                                  )
                                ],
                              )
                      ],
